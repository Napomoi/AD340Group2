package com.gmail.donaldma2022.us.riskodds;
...
public class SingleBattle extends AppCompatActivity implements 	View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnAddAttacker = (Button) findViewById(R.id.btnAddAttacker);
        txtAttackingArmyCount = (TextView) findViewById(R.id.attackingArmiesCount);
        Button btnRemoveAttacker = (Button) findViewById(R.id.btnRemoveAttacker);
        //Defending
        TextView txtDefendingArmySize = (TextView) findViewById(R.id.defendingArmies);
        Button btnAddDefender = (Button) findViewById(R.id.btnAddDefender);
        txtDefenderArmyCount = (TextView) findViewById(R.id.defendingArmiesCount);
        Button btnRemoveDefender = (Button) findViewById(R.id.btnRemoveDefender);
...
//        btnNewButton.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnSubmit:
                double oddsOfWinning = newodds[AttackingArmiesCount-1][DefenderArmiesCount - 1];
